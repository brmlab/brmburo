...
class BankTransaction(Model):
    ...
    recipient_message  = CharField(max_length=300, verbose_name='Recipient Message',null=True,blank=True)
    comment = CharField(max_length=300, verbose_name='Comment',null=True,blank=True)
