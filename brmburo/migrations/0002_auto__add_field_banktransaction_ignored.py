...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BankTransaction.ignored'
        db.add_column(u'brmburo_banktransaction', 'ignored',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BankTransaction.ignored'
        db.delete_column(u'brmburo_banktransaction', 'ignored')
