...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Buddy', fields ['uid']
        db.create_unique(u'brmburo_buddy', ['uid'])


    def backwards(self, orm):
        # Removing unique constraint on 'Buddy', fields ['uid']
        db.delete_unique(u'brmburo_buddy', ['uid'])
