...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'brmburo_bankaccount', 'account_number', self.gf('django.db.models.fields.CharField')(max_length=30))

    def backwards(self, orm):

        # Changing field 'BankAccount.account_number'
        db.alter_column(u'brmburo_bankaccount', 'account_number', self.gf('django.db.models.fields.CharField')(max_length=20))
    ...
    models = {
        ...
        u'brmburo.bankaccount': {
            ...
            'account_number': ('django.db.models.fields.CharField', [], {'max_length': '30'}),
