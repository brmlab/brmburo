...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'roster_logicaccount', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('currency', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['roster.Currency'])),
            ('type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['roster.LogicAccountType'])),
        ))
        db.send_create_signal(u'roster', ['LogicAccount'])

        # Adding model 'LogicAccountType'
        db.create_table(u'roster_logicaccounttype', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal(u'roster', ['LogicAccountType'])

        # Adding model 'LogicTransactionSplit'
        db.create_table(u'roster_logictransactionsplit', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('tid', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['roster.LogicTransaction'])),
            ('side', self.gf('django.db.models.fields.IntegerField')()),
            ('account', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['roster.LogicAccount'])),
        ...
        db.send_create_signal(u'roster', ['LogicTransactionSplit'])

        # Adding model 'LogicTransaction'
        db.create_table(u'roster_logictransaction', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('time', self.gf('django.db.models.fields.DateTimeField')()),
            ('comment', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
        ))
        db.send_create_signal(u'roster', ['LogicTransaction'])

        # Adding field 'BankAccount.currency'
        db.add_column(u'roster_bankaccount', 'currency',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['roster.Currency']),
                      keep_default=False)

        # Deleting field 'BankTransaction.buddy'
        db.delete_column(u'roster_banktransaction', 'buddy_id')


        # Changing field 'BankTransaction.amount'
        db.alter_column(u'roster_banktransaction', 'amount', self.gf('django.db.models.fields.DecimalField')(max_digits=8, decimal_places=2))

    def backwards(self, orm):
        # Deleting model 'LogicAccount'
        db.delete_table(u'roster_logicaccount')

        # Deleting model 'LogicAccountType'
        db.delete_table(u'roster_logicaccounttype')

        # Deleting model 'LogicTransactionSplit'
        db.delete_table(u'roster_logictransactionsplit')

        # Deleting model 'LogicTransaction'
        db.delete_table(u'roster_logictransaction')

        # Deleting field 'BankAccount.currency'
        db.delete_column(u'roster_bankaccount', 'currency_id')

        # Adding field 'BankTransaction.buddy'
        db.add_column(u'roster_banktransaction', 'buddy',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['roster.Buddy'], null=True, blank=True),
                      keep_default=False)


        # Changing field 'BankTransaction.amount'
        db.alter_column(u'roster_banktransaction', 'amount', self.gf('django.db.models.fields.FloatField')())
    ...
    models = {
        ...
        u'roster.logictransactionsplit': {
            ...
            'tid': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['roster.LogicTransaction']"})
        },
