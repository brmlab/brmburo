...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BankAccount.currency'
        db.alter_column(u'roster_bankaccount', 'currency_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['roster.Currency'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'BankAccount.currency'
        raise RuntimeError("Cannot reverse this migration. 'BankAccount.currency' and its values cannot be restored.")
