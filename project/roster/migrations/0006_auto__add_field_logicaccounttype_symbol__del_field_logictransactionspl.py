...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LogicAccountType.symbol'
        db.add_column(u'roster_logicaccounttype', 'symbol',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=10),
                      keep_default=False)

        # Deleting field 'LogicTransactionSplit.tid'
        db.rename_column(u'roster_logictransactionsplit', 'tid_id', 'transaction_id')

        # Adding field 'BankAccount.logic_account'
        db.add_column(u'roster_bankaccount', 'logic_account',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['roster.LogicAccount'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'BankTransaction.logic_transaction'
        db.add_column(u'roster_banktransaction', 'logic_transaction',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['roster.LogicTransaction'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LogicAccountType.symbol'
        db.delete_column(u'roster_logicaccounttype', 'symbol')

        # Deleting field 'LogicTransactionSplit.transaction'
        db.rename_column(u'roster_logictransactionsplit', 'transaction_id', 'tid_id')

        # Deleting field 'BankAccount.logic_account'
        db.delete_column(u'roster_bankaccount', 'logic_account_id')

        # Deleting field 'BankTransaction.logic_transaction'
        db.delete_column(u'roster_banktransaction', 'logic_transaction_id')
