...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LogicAccountType.parent'
        db.add_column(u'roster_logicaccounttype', 'parent',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['roster.LogicAccountType'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LogicAccountType.parent'
        db.delete_column(u'roster_logicaccounttype', 'parent_id')
